...
Public Class FrmFacturaSerialesCRUD
    ...
    End Sub
    Public Sub New(operTitle As String, values As FacturaSeriales, modo As Boolean)
        ' This call is required by the designer
        InitializeComponent()
    ...
    Private Sub getStruct()
        ...
        Dim r As Integer = 0
        For Each rw As String In FacturaSerialesController.getColumns()
    ...
    End Sub
    Private Sub updates()
        FacturaSerialesController.update(
New FacturaSeriales With {
.Id = Convert.ToInt32(DataGridView1.Item(1, 0).Value),
.SerieA = Convert.ToInt32(DataGridView1.Item(1, 1).Value),
.SerieB = Convert.ToInt32(DataGridView1.Item(1, 2).Value)})
    End Sub
...
Handles Button1.Click, Button2.Click
    ...
    Handles DataGridView1.CellValidating
        If e.ColumnIndex = 1 Then
            If e.RowIndex = 1 Or e.RowIndex = 2 Then
                Dim patron As Decimal
                If Decimal.TryParse(e.FormattedValue.ToString, patron) Then
    ...
    Private Sub DataGridView1_EditingControlShowing(sender As Object, e As DataGridViewEditingControlShowingEventArgs) Handles DataGridView1.EditingControlShowing
        ...
        If DataGridView1.CurrentCell.ColumnIndex = 1 Then
            ...
            If DataGridView1.CurrentCell.RowIndex = 1 Or DataGridView1.CurrentCell.RowIndex = 2 Then
