Public Class FrmProveedores
    Private WithEvents ctrl As New ProveedoresController
    Private datas As New List(Of Proveedores)
    ...
    Private Sub getList()
        datas.Clear()
        For Each rw As DataRow In ProveedoresController.getList().Tables(0).Rows
            datas.Add(New Proveedores With {
    ...
    Private Sub getFilterList()
        ...
        Try
            Select Case ToolStripComboBox1.SelectedIndex
                ...
                Case 2
                    DataGridView1.DataSource = datas.Where(Function(x) x.Razon.StartsWith(ToolStripTextBox1.Text.Trim(), StringComparison.InvariantCultureIgnoreCase)).ToList()
                Case 3
    ...
    Private Sub clcksBtns(sender As Object, e As EventArgs) Handles ToolStripButton1.Click, ToolStripButton2.Click, ToolStripButton3.Click, ToolStripButton4.Click, ToolStripButton5.Click
        ...
        If sender.Equals(ToolStripButton1) Then
            Dim frm As New FrmProveedoresCRUD(
            "Iniciar Alta",
...
False)
        ...
        If sender.Equals(ToolStripButton2) And DataGridView1.Rows.Count > 0 Then
            Dim ip As DialogResult = MessageBox.Show("¿Desea Eliminar este Registro ahora?", "ELIMINAR REGISTRO", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation)
            If ip = DialogResult.Yes Then
                Dim idx As Integer = DataGridView1.CurrentRow.Index
                Dim frm As New FrmProveedoresCRUD()
                frm.delete(New Proveedores With {
