Imports DBM
Public Class FacturaSerialesController
    Public Shared Event SuccessProcess()
    Public Shared Event ErrorProcess()

    Private Shared classes As New FacturaSeriales
    ...
    Public Shared Function getList() As DataSet
        Try
            ...
            Return DBQueries.queryNonExecute("FacturasSeriales_CRUD", dic)
        ...
        End Try
    End Function
    Public Shared Sub insert(values As FacturaSeriales)
        'no utilizado
    End Sub
    Public Shared Sub delete(values As FacturaSeriales)
        'no utilizado
    End Sub

    Public Shared Sub update(values As FacturaSeriales)
        Try
            Dim dic As New Dictionary(Of String, String)
            dic.Clear()
            dic.Add("@operation", "UPDATE")
            dic.Add("@id", values.Id.ToString)
            dic.Add("@seriea", values.SerieA.ToString)
            dic.Add("@serieb", values.SerieB.ToString)
            DBQueries.queryExecute("FacturasSeriales_CRUD", dic, values)
