...
Public Class FacturaAController
    Public Shared Event SuccessProcess()
    Public Shared Event ErrorProcess()

    Private Shared classes As New FacturaA
    ...
    Public Shared Sub insert(values As FacturaA)
        Try
            Dim dic As New Dictionary(Of String, String)
            dic.Clear()
            dic.Add("@operation", "INSERT")
            dic.Add("@facturaaserie", values.FacturaASerie)
            ...
            dic.Add("@subtotal1", values.Subtotal1.ToString)
            dic.Add("@impuesto", values.Impuesto.ToString)
            dic.Add("@subtotal2", values.Subtotal2.ToString)
            dic.Add("@total", values.Total.ToString)
            DBQueries.queryExecute("FacturaA_CRUD", dic, values)
