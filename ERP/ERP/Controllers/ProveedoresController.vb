...
Public Class ProveedoresController
    ...
    Private Shared classes As New Proveedores
    ...
    Public Shared Function getList() As DataSet
        Try
            ...
            Return DBQueries.queryNonExecute("Proveedores_CRUD", dic)
    ...
    Public Shared Sub insert(values As Proveedores)
        Try
            Dim dic As New Dictionary(Of String, String)
            dic.Clear()
            ...
            DBQueries.queryExecute("Proveedores_CRUD", dic, values)
    ...
    Public Shared Sub delete(values As Proveedores)
        Try
            Dim dic As New Dictionary(Of String, String)
            dic.Clear()
        ...
        End Try
    End Sub
    Public Shared Sub update(values As Proveedores)
        Try
            Dim dic As New Dictionary(Of String, String)
            dic.Clear()
